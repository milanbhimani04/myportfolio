        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900">
              Hello, I'm <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">Milan Bhimani</span><span className="animate-wave">👋</span>
            </h1>
          ...
          <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            "Crafting clean, efficient, and innovative web solutions."
          </p>
